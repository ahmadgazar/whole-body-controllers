...
% 'FontName','Times')
% 
% ax3                     = subplot(4,1,3); %state subplot
% plot(time, state, 'linewidth',2)
% title('State',...
% 'FontUnits','points',...
% 'FontWeight','normal',...
...
% 
% figure('rend','painters','pos',[10 10 600 520]);
% ax1                          = subplot(4,1,1); % Torso desired joint torques subplot
% plot(time(4700:4900), torso_roll_desired(4700:4900),'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), torso_pitch_desired(4700:4900), 'Color',C(2,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), torso_yaw_desired(4700:4900),'Color', C(3,:), 'linewidth',2)
% 
% grid on
...
% 
% 
% ax2                        = subplot(4,1,2); % left arm desired joint torque subplot
% plot(time(4700:4900), left_shoulder_roll_desired(4700:4900),'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_shoulder_pitch_desired(4700:4900), 'Color',C(2,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_shoulder_yaw_desired(4700:4900),'Color', C(3,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_elbow_desired(4700:4900),'Color', C(4,:), 'linewidth',2)
% grid on
% 
...
% 
% 
% ax3                       = subplot(4,1,3); % right arm desired joint torque subplot
% plot(time(4700:4900), right_shoulder_roll_desired(4700:4900),'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_shoulder_pitch_desired(4700:4900), 'Color',C(2,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_shoulder_yaw_desired(4700:4900),'Color', C(3,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_elbow_desired(4700:4900),'Color', C(4,:), 'linewidth',2)
% grid on
% 
...
% 
% ax4                       = subplot(4,1,4); %state subplot
% plot(time(4700:4900), state(4700:4900), 'linewidth',2)
% title('State',...
% 'FontUnits','points',...
% 'FontWeight','normal',...
% 'FontSize',10,...
...
% 
% figure('rend','painters','pos',[10 10 600 520]);
% ax1                       = subplot(3,1,1); % left leg desired joint torque subplot
% plot(time(4700:4900), left_hip_roll_desired(4700:4900),'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_hip_pitch_desired(4700:4900), 'Color',C(2,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_hip_yaw_desired(4700:4900),'Color', C(3,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_knee_desired(4700:4900),'Color', C(4,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_ankle_roll_desired(4700:4900),'Color', C(5,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), left_ankle_pitch_desired(4700:4900),'Color', C(6,:), 'linewidth',2)
% grid on
% 
...
% grid on
% 
% ax2                       = subplot(3,1,2); % right leg desired joint torque subplot
% plot(time(4700:4900), right_hip_roll_desired(4700:4900),'Color', C(1,:), 'linewidth',2)
% ylim([-10 5])
% hold on
% plot(time(4700:4900), right_hip_pitch_desired(4700:4900), 'Color',C(2,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_hip_yaw_desired(4700:4900),'Color', C(3,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_knee_desired(4700:4900),'Color', C(4,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_ankle_roll_desired(4700:4900),'Color', C(5,:), 'linewidth',2)
% hold on
% plot(time(4700:4900), right_ankle_pitch_desired(4700:4900),'Color', C(6,:), 'linewidth',2)
% grid on
% 
...
% grid on
% 
% ax3                      = subplot(3,1,3); %state subplot
% plot(time(4700:4900), state(4700:4900), 'linewidth',2)
% title('State',...
% 'FontUnits','points',...
% 'FontWeight','normal',...
...
%% plot linear and angular momentum derivatives
state         =  comData.signals(4).values(:);
time          = H_dot_linear.time;
N             = 3;
C             = linspecer(N);

% linear momentum error
linear_momentum_dot_x = H_dot_linear.signals(1).values(:,1);
linear_momentum_dot_y = H_dot_linear.signals(1).values(:,2);
linear_momentum_dot_z = H_dot_linear.signals(1).values(:,3);

% angular momentum error
angular_momentum_dot_x = H_dot_angular.signals(1).values(:,1);
angular_momentum_dot_y = H_dot_angular.signals(1).values(:,2);
angular_momentum_dot_z = H_dot_angular.signals(1).values(:,3);

% state
state                        =  comData.signals(4).values(:);

figure('rend','painters','pos',[10 10 600 520]);
ax1 = subplot(2,1,1); % linear momentum derivative subplot
plot(time, linear_momentum_dot_x, time, linear_momentum_dot_y, time, linear_momentum_dot_z)
grid on
...
ax2 = subplot(2,1,2); % angular momentum derivative subplot
plot(time, angular_momentum_dot_x, time, angular_momentum_dot_y, time, angular_momentum_dot_z)
grid on
title(ax2,'angular momentum derivative')
legend('$x$','$y$','$z$')
...
print -depsc2 momentum_derivative.eps
