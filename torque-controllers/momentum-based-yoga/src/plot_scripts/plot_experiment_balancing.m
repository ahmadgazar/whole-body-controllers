...
%% Readings from F/T sensors

% estimated left foot wrenches
% time          = FT_sensors.time;
% left_F_x_estimated  = FT_sensors.signals(1).values(:,1);
% 
% left_F_y_estimated  = FT_sensors.signals(1).values(:,2);
% 
% left_F_z_estimated  = FT_sensors.signals(1).values(:,3);
% 
% left_M_x_estimated  = FT_sensors.signals(1).values(:,4);
% 
% left_M_y_estimated  = FT_sensors.signals(1).values(:,5);
% 
% left_M_z_estimated  = FT_sensors.signals(1).values(:,6);
% 
% 
% right_F_x_estimated =  FT_sensors.signals(2).values(:,1);
% 
% right_F_y_estimated =  FT_sensors.signals(2).values(:,2);
% 
% right_F_z_estimated =  FT_sensors.signals(2).values(:,3);
% 
% right_M_x_estimated =  FT_sensors.signals(2).values(:,4);
% 
% right_M_y_estimated =  FT_sensors.signals(2).values(:,5);
% 
% right_M_z_estimated =  FT_sensors.signals(2).values(:,6);
% 
% figure(1);
% %ax1                 = subplot(2,1,1); % left estimated wrenches subplot
% plot(time, left_F_x_estimated,'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time, left_F_y_estimated, 'Color',C(2,:), 'linewidth',2)
% hold on
...
% 'FontName','Times')
% 
% print -depsc2 left_ft_sensor.eps
% 
% figure(2);
% %ax2                 = subplot(2,2,2); % right estimated wrenches subplot
% plot(time, right_F_x_estimated,'Color', C(1,:), 'linewidth',2)
% hold on
% plot(time, right_F_y_estimated, 'Color',C(2,:), 'linewidth',2)
% hold on
...
% grid on
% 
% print -depsc2 right_ft_sensor.eps